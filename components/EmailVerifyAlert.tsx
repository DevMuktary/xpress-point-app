...
export default function EmailVerifyAlert() {
  ...
  const handleResend = async () => {
    ...
    try {
      // [FIXED] Changed from /api/auth/resend-otp to /api/auth/resend-email
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            {/* [ADJUSTED TEXT] Changed "code" to "link" to be more accurate */}
            <p className="mt-1 text-sm text-yellow-700">
              We sent a verification link to your email. If you don't see it, <span className="font-bold underline">check your Spam/Junk folder</span> and mark as "Not Spam".
            </p>
            {message && (
        ...
        >
          {loading ? (
            ...
            // [ADJUSTED TEXT] Changed "Resend Code" to "Resend Link"
            "Resend Link"
          )}
        </button>
      </div>
