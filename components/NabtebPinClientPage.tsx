...
export default function NabtebPinClientPage({ serviceId, serviceFee, isActive }: Props) {
  ...
  if (!isActive) {
    return (
      <ServiceUnavailable 
        message="The NABTEB Result Pin service is currently unavailable. Please check back later." 
      />
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-lg mt-6">
        <h3 className="text-lg font-semibold text-gray-900">My NABTEB PIN History</h3>
        ...
        {!isHistoryLoading && requests.length === 0 && <div className="py-8 text-center text-gray-500"><DocumentMagnifyingGlassIcon className="mx-auto h-12 w-12" /><p className="mt-2 font-semibold">No History Found</p><p className="text-sm">You have not purchased any NABTEB pins yet.</p></div>}
      ...
      {isConfirmModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl">
            ...
            <div className="p-6">
              <p className="text-center text-gray-600">Are you sure you want to purchase {quantity} NABTEB PIN(s) for {phoneNumber}? This action is irreversible.</p>
