...
// platformPrice = What *we* (Super-Admin) pay the API provider
// defaultAgentPrice = The "stunning" default price an Agent sees
const services = [
  // --- NIN Services ---
  ...
  { id: 'DATA_GLO_CLOUD_50MB_1D', name: 'Glo Cloud 50MB (1 Day)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(50), defaultAgentPrice: new Decimal(50), productCode: 'glo_cloud_50mb_incl_5mb_nite1day' },
  { id: 'DATA_GLO_CLOUD_350MB_2D', name: 'Glo Cloud 350MB (2 Days)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(100), defaultAgentPrice: new Decimal(100), productCode: 'glo_cloud_350mb_incl_110mb_nite2days' },
  { id: 'DATA_GLO_CLOUD_1_8GB_14D', name: 'Glo Cloud 1.8GB (14 Days)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(500), defaultAgentPrice: new Decimal(500), productCode: 'glo_cloud_1_8gb_incl_1gb_nite14days' },
  { id: 'DATA_GLO_CLOUD_150MB_1D', name: 'Glo Cloud 150MB (1 Day)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(100), defaultAgentPrice: new Decimal(100), productCode: 'glo_cloud_150mb_incl_35mb_nite1day' },
  { id: 'DATA_GLO_CLOUD_250MB_N_1D', name: 'Glo Cloud 250MB Night (1 Day)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(100), defaultAgentPrice: new Decimal(100), productCode: 'glo_cloud_250mb_night1day' },
  { id: 'DATA_GLO_CLOUD_7GB_S_7D', name: 'Glo Cloud 7GB Special (7 Days)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(1500), defaultAgentPrice: new Decimal(1500), productCode: 'glo_cloud_7gb_special7days' },
