...
// This list contains all 170+ services
const services = [
  // --- NIN Services ---
  ...
  { id: 'DATA_MTN_GIFT_10GB_30D_B', name: 'MTN Gifting 10GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(4450), defaultAgentPrice: new Decimal(4477.5), productCode: 'mtn_10gb_30days' },
  { id: 'DATA_MTN_GIFT_2_7GB_30D_B', name: 'MTN Gifting 2.7GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(1970), defaultAgentPrice: new Decimal(1990), productCode: 'mtn_2_7gb_30days' },
  { id: 'DATA_MTN_GIFT_20GB_30D_B', name: 'MTN Gifting 20GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(7420), defaultAgentPrice: new Decimal(7462.5), productCode: 'mtn_20gb_30days' },
  { id: 'DATA_MTN_GIFT_25GB_30D_B', name: 'MTN Gifting 25GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(8900), defaultAgentPrice: new Decimal(8955), productCode: 'mtn_25gb_30days' },
  { id: 'DATA_MTN_GIFT_75GB_30D_B', name: 'MTN Gifting 75GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(17800), defaultAgentPrice: new Decimal(17910), productCode: 'mtn_75gb_30days' },
  { id: 'DATA_MTN_GIFT_250GB_30D_B', name: 'MTN Gifting 250GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(54600), defaultAgentPrice: new Decimal(54725), productCode: 'mtn_250gb_30days' },
  { id: 'DATA_MTN_GIFT_90GB_60D_B', name: 'MTN Gifting 90GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(24750), defaultAgentPrice: new Decimal(24875), productCode: 'mtn_90gb_60days' },
  { id: 'DATA_MTN_GIFT_200GB_60D_B', name: 'MTN Gifting 200GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(49600), defaultAgentPrice: new Decimal(49750), productCode: 'mtn_200gb_60days' },
  { id: 'DATA_MTN_GIFT_150GB_60D_B', name: 'MTN Gifting 150GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(39600), defaultAgentPrice: new Decimal(39800), productCode: 'mtn_150gb_60days' },
  { id: 'DATA_MTN_GIFT_2GB_30D_B', name: 'MTN Gifting 2GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(1470), defaultAgentPrice: new Decimal(1492.5), productCode: 'mtn_2gb_30days' },
  { id: 'DATA_MTN_GIFT_3_5GB_30D_B', name: 'MTN Gifting 3.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(2460), defaultAgentPrice: new Decimal(2487.5), productCode: 'mtn_3_5gb_30days' },
  { id: 'DATA_MTN_GIFT_12_5GB_30D_B', name: 'MTN Gifting 12.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(5430), defaultAgentPrice: new Decimal(5472.5), productCode: 'mtn_12_5gb_30days' },
  { id: 'DATA_MTN_GIFT_16_5GB_30D_B', name: 'MTN Gifting 16.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(6420), defaultAgentPrice: new Decimal(6467.5), productCode: 'mtn_16_5gb_30days' },
  { id: 'DATA_MTN_GIFT_36GB_30D_B', name: 'MTN Gifting 36GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(10900), defaultAgentPrice: new Decimal(10945), productCode: 'mtn_36gb_30days' },
  { id: 'DATA_MTN_GIFT_165GB_30D_B', name: 'MTN Gifting 165GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(34700), defaultAgentPrice: new Decimal(34825), productCode: 'mtn_165gb_30days' },
  { id: 'DATA_MTN_GIFT_7GB_30D_B', name: 'MTN Gifting 7GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(3450), defaultAgentPrice: new Decimal(3482.5), productCode: 'mtn_7gb_30days' },
  { id: 'DATA_MTN_GIFT_800GB_365D_B', name: 'MTN Gifting 800GB (365 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(124000), defaultAgentPrice: new Decimal(124375), productCode: 'mtn_800gb_365_days' },
...
ELEC_AEDC_POST', name: 'AEDC PostPaid', category: 'VTU_ELEC', platformPrice: new Decimal(99), defaultAgentPrice: new Decimal(100), productCode: 'aedc_postpaid_custom' },
  ...
  { id: 'ELEC_PHED_PRE', name: 'PH PrePaid', category: 'VTU_ELEC', platformPrice: new Decimal(99), defaultAgentPrice: new Decimal(1D', name: 'MTN Awoof 3.5GB (7 Days)', category: 'VTU_DATA_AWOOF', platformPrice: new Decimal(1460), defaultAgentPrice: new Decimal(1485), productCode: 'mtn_3_5gb7_days_plan' },
  ...
  // --- VTU Electricity ---
  { id: '00), productCode: 'phed_prepaid_custom' },
...
async function main() {
  ...
  for (const service of services) {
    await prisma.service.upsert({
      ...
      create: {
        ...service,
        // Ensure 'isActive' has a default if not provided
        isActive: service.isActive !== undefined ? service.isActive : true,
      },
    });
  }
