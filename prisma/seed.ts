...
// platformPrice = What *we* (Super-Admin) pay the API provider (the old 'aggregatorPrice')
// defaultAgentPrice = The "stunning" default price an Agent sees (the old 'agentPrice')
const services = [
  // --- NIN Services ---
  ...
  { id: 'DATA_MTN_GIFT_10GB_30D_B', name: 'MTN 10GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(4450), defaultAgentPrice: new Decimal(4477.5), productCode: 'mtn_10gb_30days' },
  { id: 'DATA_MTN_GIFT_2_7GB_30D_B', name: 'MTN 2.7GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(1970), defaultAgentPrice: new Decimal(1990), productCode: 'mtn_2_7gb_30days' },
  { id: 'DATA_MTN_GIFT_20GB_30D_B', name: 'MTN 20GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(7420), defaultAgentPrice: new Decimal(7462.5), productCode: 'mtn_20gb_30days' },
  { id: 'DATA_MTN_GIFT_25GB_30D_B', name: 'MTN 25GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(8900), defaultAgentPrice: new Decimal(8955), productCode: 'mtn_25gb_30days' },
  { id: 'DATA_MTN_GIFT_75GB_30D_B', name: 'MTN 75GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(17800), defaultAgentPrice: new Decimal(17910), productCode: 'mtn_75gb_30days' },
  { id: 'DATA_MTN_GIFT_250GB_30D_B', name: 'MTN 250GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(54600), defaultAgentPrice: new Decimal(54725), productCode: 'mtn_250gb_30days' },
  { id: 'DATA_MTN_GIFT_90GB_60D_B', name: 'MTN 90GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(24750), defaultAgentPrice: new Decimal(24875), productCode: 'mtn_90gb_60days' },
  { id: 'DATA_MTN_GIFT_200GB_60D_B', name: 'MTN 200GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(49600), defaultAgentPrice: new Decimal(49750), productCode: 'mtn_200gb_60days' },
  { id: 'DATA_MTN_GIFT_150GB_60D_B', name: 'MTN 150GB (60 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(39600), defaultAgentPrice: new Decimal(39800), productCode: 'mtn_150gb_60days' },
  { id: 'DATA_MTN_GIFT_2GB_30D_B', name: 'MTN 2GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(1470), defaultAgentPrice: new Decimal(1492.5), productCode: 'mtn_2gb_30days' },
  { id: 'DATA_MTN_GIFT_3_5GB_30D_B', name: 'MTN 3.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(2460), defaultAgentPrice: new Decimal(2487.5), productCode: 'mtn_3_5gb_30days' },
  { id: 'DATA_MTN_GIFT_12_5GB_30D_B', name: 'MTN 12.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(5430), defaultAgentPrice: new Decimal(5472.5), productCode: 'mtn_12_5gb_30days' },
  { id: 'DATA_MTN_GIFT_16_5GB_30D_B', name: 'MTN 16.5GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(6420), defaultAgentPrice: new Decimal(6467.5), productCode: 'mtn_16_5gb_30days' },
  { id: 'DATA_MTN_GIFT_36GB_30D_B', name: 'MTN 36GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(10900), defaultAgentPrice: new Decimal(10945), productCode: 'mtn_36gb_30days' },
  { id: 'DATA_MTN_GIFT_165GB_30D_B', name: 'MTN 165GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(34700), defaultAgentPrice: new Decimal(34825), productCode: 'mtn_165gb_30days' },
  { id: 'DATA_MTN_GIFT_7GB_30D_B', name: 'MTN 7GB (30 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(3450), defaultAgentPrice: new Decimal(3482.5), productCode: 'mtn_7gb_30days' },
  { id: 'DATA_MTN_GIFT_800GB_365D_B', name: 'MTN 800GB (365 Days)', category: 'VTU_DATA_GIFTING', platformPrice: new Decimal(124000), defaultAgentPrice: new Decimal(124375), productCode: 'mtn_800gb_365_days' },
  ...
  { id: 'DATA_GLO_CLOUD_250MB_N_1D_A', name: 'Glo Cloud 250MB Night (1 Day)', category: 'VTU_DATA_CLOUD', platformPrice: new Decimal(100), defaultAgentPrice: new Decimal(100), productCode: 'glo_cloud_250mb_night1day' },
  ...
  // --- VTU Data: MTN SME ---
  { id: 'DATA_MTN_SME_1GB_A', name: 'MTN SME 1GB', category: 'VTU_DATA_SME', platformPrice: new Decimal(470), defaultAgentPrice: new Decimal(480), productCode: 'mtn_sme_1gb' },
  { id: 'DATA_MTN_SME_2GB_A', name: 'MTN SME 2GB', category: 'VTU_DATA_SME', platformPrice: new Decimal(1080), defaultAgentPrice: new Decimal(1100), productCode: 'data_share_2gb' },
  { id: 'DATA_MTN_SME_5GB_A', name: 'MTN SME 5GB', category: 'VTU_DATA_SME', platformPrice: new Decimal(2730), defaultAgentPrice: new Decimal(2750), productCode: 'data_share_5gb' },
  { id: 'DATA_MTN_SME_500MB_A', name: 'MTN SME 500MB', category: 'VTU_DATA_SME', platformPrice: new Decimal(360), defaultAgentPrice: new Decimal(365), productCode: 'mtn_sme_500mb' },
  { id: 'DATA_MTN_SME_3GB_A', name: 'MTN SME 3GB', category: 'VTU_DATA_SME', platformPrice: new Decimal(1630), defaultAgentPrice: new Decimal(1650), productCode: 'data_share_3gb' },
  { id: 'DATA_MTN_SME_10GB_A', name: 'MTN SME 10GB', category: 'VTU_DATA_SME', platformPrice: new Decimal(5450), defaultAgentPrice: new Decimal(5500), productCode: 'data_share_10gb' },
  { id: 'DATA_MTN_SME_1GB_M_A', name: 'MTN SME 1GB Monthly', category: 'VTU_DATA_SME', platformPrice: new Decimal(580), defaultAgentPrice: new Decimal(590), productCode: 'mtn_sme_igb_monthly' },

  // --- VTU Data: Glo Corporate ---
  { id: 'DATA_GLO_CG_200MB_14D_A', name: 'Glo CG 200MB (14 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(78), defaultAgentPrice: new Decimal(79.8), productCode: 'glo_cg_200mb_14days' },
  { id: 'DATA_GLO_CG_500MB_30D_A', name: 'Glo CG 500MB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(195), defaultAgentPrice: new Decimal(199.5), productCode: 'glo_cg_500mb_30days' },
  { id: 'DATA_GLO_CG_1GB_30D_A', name: 'Glo CG 1GB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(390), defaultAgentPrice: new Decimal(399), productCode: 'glo_cg_1gb_30days' },
  { id: 'DATA_GLO_CG_2GB_30D_A', name: 'Glo CG 2GB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(790), defaultAgentPrice: new Decimal(798), productCode: 'glo_cg_2gb_30days' },
  { id: 'DATA_GLO_CG_3GB_30D_A', name: 'Glo CG 3GB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(1180), defaultAgentPrice: new Decimal(1197), productCode: 'glo_cg_3gb_30days' },
  { id: 'DATA_GLO_CG_5GB_30D_A', name: 'Glo CG 5GB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(1980), defaultAgentPrice: new Decimal(1995), productCode: 'glo_cg_5gb_30days' },
  { id: 'DATA_GLO_CG_10GB_30D_A', name: 'Glo CG 10GB (30 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(3970), defaultAgentPrice: new Decimal(3990), productCode: 'glo_cg_10gb_30days' },
  { id: 'DATA_GLO_CG_1GB_3D_A', name: 'Glo CG 1GB (3 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(265), defaultAgentPrice: new Decimal(270), productCode: 'glo_cg_1gb_3_days' },
  { id: 'DATA_GLO_CG_3GB_3D_A', name: 'Glo CG 3GB (3 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(800), defaultAgentPrice: new Decimal(810), productCode: 'glo_cg_3gb_3_days' },
  { id: 'DATA_GLO_CG_5GB_3D_A', name: 'Glo CG 5GB (3 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(1330), defaultAgentPrice: new Decimal(1350), productCode: 'glo_cg_5gb_3_days' },
  { id: 'DATA_GLO_CG_1GB_7D_A', name: 'Glo CG 1GB (7 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(310), defaultAgentPrice: new Decimal(320), productCode: 'glo_cg_1gb_7_days' },
  { id: 'DATA_GLO_CG_3GB_7D_A', name: 'Glo CG 3GB (7 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(940), defaultAgentPrice: new Decimal(960), productCode: 'glo_cg_3gb_7_days' },
  { id: 'DATA_GLO_CG_5GB_7D_A', name: 'Glo CG 5GB (7 Days)', category: 'VTU_DATA_CG', platformPrice: new Decimal(1580), defaultAgentPrice: new Decimal(1600), productCode: 'glo_cg_5gb_7_days' },
