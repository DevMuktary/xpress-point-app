...
import DelinkHistoryClientPage from '@/components/DelinkHistoryClientPage'; // We will create this next

// This is a Server Component. It fetches data on the server.
export default async function NinDelinkHistoryPage() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      */}
      <DelinkHistoryClientPage initialRequests={requests} />
    </div>
  );
}
