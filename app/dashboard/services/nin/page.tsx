...
import SafeImage from '@/components/SafeImage'; // Use our "world-class" safe image
...
export default function NinServicesPage() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      {/* This stacks to 1-column on mobile, just as you wanted */}
