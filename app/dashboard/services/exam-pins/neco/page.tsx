...
export default function NecoPinPage() {
  
  // --- This is the "World-Class" Service ID ---
  const SERVICE_ID = "NECO_PIN";
  const SERVICE_FEE = 1250; // The Agent price
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <SafeImage
          src="/logos/neco.png" // <-- Refurbished
          alt="NECO Logo"
          width={40}
          height={40}
      ...
      <div className="rounded-2xl bg-white p-6 shadow-lg mt-6">
        ...
        {!isHistoryLoading && requests.length === 0 && (
          <div className="py-8 text-center text-gray-500">
            ...
            <p className="text-sm">You have not purchased any NECO pins yet.</p>
          </div>
        )}
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl">
            ...
            <div className="p-6">
              <p className="text-center text-gray-600">
                Are you sure you want to purchase {quantity} NECO PIN(s) for {phoneNumber}? This action is irreversible.
              </p>
