...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.log(`[DEBUG] Calling ConfirmIdent NIN v3 with value: ${nin}`);
    ...
    console.log("--- FULL CONFIRMIDENT NIN RESPONSE ---");
    ...
    console.error(`NIN Lookup (NIN) Unhandled Error:`, error);
    return NextResponse.json(
